...
// Test validateCred with valid and invalid credit card numbers
...
const findInvalidCards = (cardNumbers) => {
  return cardNumbers.filter(card => !validateCred(card));
};

// Test findInvalidCards with the provided batch array
...
// Test idInvalidCardCompanies with the invalid cards from the batch
